...
\draw[rounded corners=6pt, fill=blue!12, draw=blue!70!black, line width=0.7pt] (0,0) rectangle (4.0,-4.6);
\draw[rounded corners=3pt, fill=white, draw=blue!70!black, line width=1pt] (0.15,-0.15) rectangle (3.85,-0.95);
\node[align=center, font=\bfseries\small, text=blue!70!black, text width=3.4cm] at (2.0,-0.55) {PHYSICAL FOUNDATIONS};
\foreach \x/\lbl in {0.8/{$\theta$}, 2.0/{$H(t)$}, 3.2/{$|\alpha\rangle$}} {
  \draw[fill=black, draw=white, line width=0.6pt] (\x,-1.35) circle (0.32);
  \node[text=white, font=\scriptsize] at (\x,-1.35) {\lbl};
}
\draw[rounded corners=3pt, fill=white, draw=blue!40] (0.2,-1.75) rectangle (3.8,-4.45);
\node[align=center, font=\tiny, text width=3.4cm] at (2.0,-3.1) {Maxwell's equations quantised via the atom--field Hamiltonian to coherent-state encoding $|\alpha(\theta)\rangle$ (Sec.~\ref{sec:background})};

% ---- Stage B: Cq Channel \& Noise ----
\draw[rounded corners=6pt, fill=orange!15, draw=orange!70!black, line width=0.7pt] (4.5,0) rectangle (8.5,-4.6);
\draw[rounded corners=3pt, fill=white, draw=orange!70!black, line width=1pt] (4.65,-0.15) rectangle (8.35,-0.95);
\node[align=center, font=\bfseries\small, text=orange!70!black, text width=3.4cm] at (6.5,-0.55) {Cq CHANNEL \& NOISE};
\foreach \x/\lbl in {5.3/{$\rho(x)$}, 6.5/{$\gamma$}, 7.7/{$E_k$}} {
  \draw[fill=black, draw=white, line width=0.6pt] (\x,-1.35) circle (0.32);
  \node[text=white, font=\scriptsize] at (\x,-1.35) {\lbl};
}
\draw[rounded corners=3pt, fill=white, draw=orange!40] (4.7,-1.75) rectangle (8.3,-4.45);
\node[align=center, font=\tiny, text width=3.4cm] at (6.5,-3.1) {BPSK Cq channel degraded by GKSL loss/dephasing; Holevo capacity $C(\theta)$ and ambiguity sets (Sec.~\ref{sec:problem})};

% ---- Stage C: Control \& Hardness ----
\draw[rounded corners=6pt, fill=red!12, draw=red!60!black, line width=0.7pt] (9.0,0) rectangle (13.0,-4.6);
\draw[rounded corners=3pt, fill=white, draw=red!60!black, line width=1pt] (9.15,-0.15) rectangle (12.85,-0.95);
\node[align=center, font=\bfseries\small, text=red!60!black, text width=3.4cm] at (11.0,-0.55) {CONTROL \& HARDNESS};
\foreach \x/\lbl in {9.8/{$H_c(t)$}, 11.0/{$\mathcal S_t$}, 12.2/{SJIP}} {
  \draw[fill=black, draw=white, line width=0.6pt] (\x,-1.35) circle (0.32);
  \node[text=white, font=\scriptsize] at (\x,-1.35) {\lbl};
}
\draw[rounded corners=3pt, fill=white, draw=red!40] (9.2,-1.75) rectangle (12.8,-4.45);
\node[align=center, font=\tiny, text width=3.4cm] at (11.0,-3.1) {Concurrent control $H_c(t)$ strictly raises capacity beyond the DPI ceiling; SJIP proven NP-hard (Sec.~\ref{sec:methodology})};

% ---- Stage D: Estimation \& Security ----
\draw[rounded corners=6pt, fill=green!12, draw=green!50!black, line width=0.7pt] (13.5,0) rectangle (17.5,-4.6);
\draw[rounded corners=3pt, fill=white, draw=green!50!black, line width=1pt] (13.65,-0.15) rectangle (17.35,-0.95);
\node[align=center, font=\bfseries\small, text=green!50!black, text width=3.4cm] at (15.5,-0.55) {ESTIMATION \& SECURITY};
\foreach \x/\lbl in {14.3/{$\QFIM(\Theta)$}, 15.5/{QCRB}, 16.7/{Adv}} {
  \draw[fill=black, draw=white, line width=0.6pt] (\x,-1.35) circle (0.32);
  \node[text=white, font=\scriptsize] at (\x,-1.35) {\lbl};
}
\draw[rounded corners=3pt, fill=white, draw=green!40] (13.7,-1.75) rectangle (17.3,-4.45);
\node[align=center, font=\tiny, text width=3.4cm] at (15.5,-3.1) {QFIM-saturating Bayesian estimator (Alg.~\ref{alg:estimation}) and dual-layer security bound (Cor.~\ref{cor:dual_security}) (Sec.~\ref{sec:security},~\ref{sec:simulation})};
...
% ---- Cross-cutting band ----
\draw[rounded corners=8pt, draw=black!60, line width=0.7pt] (-0.3,-5.15) rectangle (17.8,-7.95);
\draw[rounded corners=5pt, fill=yellow!25, draw=yellow!60!black, line width=0.7pt] (0.0,-5.3) rectangle (17.5,-6.0);
\node[font=\bfseries\scriptsize] at (8.75,-5.65) {CROSS-CUTTING: FIBRE PARAMETERS, NOISE RATES \& COMPUTATIONAL HARDNESS};

\draw[rounded corners=3pt, fill=blue!15, draw=blue!60!black, line width=0.6pt] (0.0,-6.3) rectangle (4.0,-7.6);
\node[align=center, font=\scriptsize, text width=3.6cm] at (2.0,-6.95) {Fibre parameters $\theta$};

\draw[rounded corners=3pt, fill=orange!18, draw=orange!60!black, line width=0.6pt] (4.5,-6.3) rectangle (8.5,-7.6);
\node[align=center, font=\scriptsize, text width=3.6cm] at (6.5,-6.95) {Noise rates $\gamma_{\mathrm{loss}}, \gamma_\varphi$};

\draw[rounded corners=3pt, fill=red!15, draw=red!60!black, line width=0.6pt] (9.0,-6.3) rectangle (13.0,-7.6);
\node[align=center, font=\scriptsize, text width=3.6cm] at (11.0,-6.95) {SJIP NP-hardness (Thm~\ref{thm:sjip_nphard})};

\draw[rounded corners=3pt, fill=red!8, draw=red!60!black, line width=0.6pt, dash pattern=on 3pt off 2pt] (13.5,-6.3) rectangle (17.5,-7.6);
\node[align=center, font=\scriptsize, text width=3.6cm] at (15.5,-6.95) {Conjecture~\ref{thm:decoding_hard} (unproven link)};

% ---- Dashed feedback arrows into stages B, C, D ----
\draw[dashed, red!70!black, thick, -{Latex[length=2.5mm]}] (6.5,-5.3) -- (6.5,-4.6);
\draw[dashed, red!70!black, thick, -{Latex[length=2.5mm]}] (11.0,-5.3) -- (11.0,-4.6);
\draw[dashed, red!70!black, thick, -{Latex[length=2.5mm]}] (15.5,-5.3) -- (15.5,-4.6);

\end{tikzpicture}%
}
\caption{Compact block diagram of the full framework. Four main
...
\begin{enumerate}[leftmargin=*, label=(\arabic*), itemsep=2pt]
  \item \textbf{Capacity scaling:}
    $C(L,a,T) = C_0\,e^{-\alphaf L}(1-e^{-\kappa/a^2})
...
and entropy quantities in~\cite{cover2006}.
