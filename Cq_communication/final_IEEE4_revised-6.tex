...
% ---- Stage A: Physical Foundations ----
\draw[rounded corners=6pt, fill=white, draw=black, line width=1pt] (0,0) rectangle (4.0,-4.6);
\draw[rounded corners=3pt, fill=black!8, draw=black, line width=1pt] (0.15,-0.15) rectangle (3.85,-0.95);
\node[align=center, font=\bfseries\small, text=black, text width=3.4cm] at (2.0,-0.55) {PHYSICAL FOUNDATIONS};
\foreach \x/\lbl in {0.8/{$\theta$}, 2.0/{$H(t)$}, 3.2/{$|\alpha\rangle$}} {
  \draw[fill=white, draw=black, line width=0.8pt] (\x,-1.35) circle (0.32);
  \node[text=black, font=\scriptsize] at (\x,-1.35) {\lbl};
}
\draw[rounded corners=3pt, fill=white, draw=black!50, line width=0.6pt] (0.2,-1.75) rectangle (3.8,-4.45);
\node[align=center, font=\small, text width=3.4cm] at (2.0,-3.1) {Maxwell's equations quantised via the atom--field Hamiltonian to coherent-state encoding $|\alpha(\theta)\rangle$ (Sec.~\ref{sec:background})};

% ---- Stage B: Cq Channel \& Noise ----
\draw[rounded corners=6pt, fill=white, draw=black, line width=1pt] (4.5,0) rectangle (8.5,-4.6);
\draw[rounded corners=3pt, fill=black!8, draw=black, line width=1pt] (4.65,-0.15) rectangle (8.35,-0.95);
\node[align=center, font=\bfseries\small, text=black, text width=3.4cm] at (6.5,-0.55) {Cq CHANNEL \& NOISE};
\foreach \x/\lbl in {5.3/{$\rho(x)$}, 6.5/{$\gamma$}, 7.7/{$E_k$}} {
  \draw[fill=white, draw=black, line width=0.8pt] (\x,-1.35) circle (0.32);
  \node[text=black, font=\scriptsize] at (\x,-1.35) {\lbl};
}
\draw[rounded corners=3pt, fill=white, draw=black!50, line width=0.6pt] (4.7,-1.75) rectangle (8.3,-4.45);
\node[align=center, font=\small, text width=3.4cm] at (6.5,-3.1) {BPSK Cq channel degraded by GKSL loss/dephasing; Holevo capacity $C(\theta)$ and ambiguity sets (Sec.~\ref{sec:problem})};

% ---- Stage C: Control \& Hardness ----
\draw[rounded corners=6pt, fill=white, draw=black, line width=1pt] (9.0,0) rectangle (13.0,-4.6);
\draw[rounded corners=3pt, fill=black!8, draw=black, line width=1pt] (9.15,-0.15) rectangle (12.85,-0.95);
\node[align=center, font=\bfseries\small, text=black, text width=3.4cm] at (11.0,-0.55) {CONTROL \& HARDNESS};
\foreach \x/\lbl in {9.8/{$H_c(t)$}, 11.0/{$\mathcal S_t$}, 12.2/{SJIP}} {
  \draw[fill=white, draw=black, line width=0.8pt] (\x,-1.35) circle (0.32);
  \node[text=black, font=\scriptsize] at (\x,-1.35) {\lbl};
}
\draw[rounded corners=3pt, fill=white, draw=black!50, line width=0.6pt] (9.2,-1.75) rectangle (12.8,-4.45);
\node[align=center, font=\small, text width=3.4cm] at (11.0,-3.1) {Concurrent control $H_c(t)$ strictly raises capacity beyond the DPI ceiling; SJIP proven NP-hard (Sec.~\ref{sec:methodology})};

% ---- Stage D: Estimation \& Security ----
\draw[rounded corners=6pt, fill=white, draw=black, line width=1pt] (13.5,0) rectangle (17.5,-4.6);
\draw[rounded corners=3pt, fill=black!8, draw=black, line width=1pt] (13.65,-0.15) rectangle (17.35,-0.95);
\node[align=center, font=\bfseries\small, text=black, text width=3.4cm] at (15.5,-0.55) {ESTIMATION \& SECURITY};
\foreach \x/\lbl in {14.3/{$\QFIM(\Theta)$}, 15.5/{QCRB}, 16.7/{Adv}} {
  \draw[fill=white, draw=black, line width=0.8pt] (\x,-1.35) circle (0.32);
  \node[text=black, font=\scriptsize] at (\x,-1.35) {\lbl};
}
\draw[rounded corners=3pt, fill=white, draw=black!50, line width=0.6pt] (13.7,-1.75) rectangle (17.3,-4.45);
\node[align=center, font=\small, text width=3.4cm] at (15.5,-3.1) {QFIM-saturating Bayesian estimator (Alg.~\ref{alg:estimation}) and dual-layer security bound (Cor.~\ref{cor:dual_security}) (Sec.~\ref{sec:security},~\ref{sec:simulation})};

% ---- Forward arrows between stages ----
\draw[very thick, -{Latex[length=3mm]}] (4.0,-2.3) -- (4.5,-2.3);
\draw[very thick, -{Latex[length=3mm]}] (8.5,-2.3) -- (9.0,-2.3);
\draw[very thick, -{Latex[length=3mm]}] (13.0,-2.3) -- (13.5,-2.3);

% ---- Cross-cutting band ----
\draw[rounded corners=8pt, draw=black, line width=0.8pt] (-0.3,-5.15) rectangle (17.8,-7.95);
\draw[rounded corners=5pt, fill=black!10, draw=black, line width=0.8pt] (0.0,-5.3) rectangle (17.5,-6.0);
\node[font=\bfseries\scriptsize, text=black] at (8.75,-5.65) {CROSS-CUTTING: FIBRE PARAMETERS, NOISE RATES \& COMPUTATIONAL HARDNESS};

\draw[rounded corners=3pt, fill=white, draw=black, line width=0.6pt] (0.0,-6.3) rectangle (4.0,-7.6);
\node[align=center, font=\small, text width=3.6cm] at (2.0,-6.95) {Fibre parameters $\theta$};

\draw[rounded corners=3pt, fill=white, draw=black, line width=0.6pt] (4.5,-6.3) rectangle (8.5,-7.6);
\node[align=center, font=\small, text width=3.6cm] at (6.5,-6.95) {Noise rates $\gamma_{\mathrm{loss}}, \gamma_\varphi$};

\draw[rounded corners=3pt, fill=white, draw=black, line width=0.6pt] (9.0,-6.3) rectangle (13.0,-7.6);
\node[align=center, font=\footnotesize, text width=3.6cm] at (11.0,-6.95) {SJIP NP-hardness (Thm~\ref{thm:sjip_nphard})};

\draw[rounded corners=3pt, fill=black!5, draw=black, line width=0.6pt, dash pattern=on 3pt off 2pt] (13.5,-6.3) rectangle (17.5,-7.6);
\node[align=center, font=\footnotesize, text width=3.6cm] at (15.5,-6.95) {Conjecture~\ref{thm:decoding_hard}};

% ---- Dashed feedback arrows into stages B, C, D ----
\draw[dashed, black, thick, -{Latex[length=2.5mm]}] (6.5,-5.3) -- (6.5,-4.6);
\draw[dashed, black, thick, -{Latex[length=2.5mm]}] (11.0,-5.3) -- (11.0,-4.6);
\draw[dashed, black, thick, -{Latex[length=2.5mm]}] (15.5,-5.3) -- (15.5,-4.6);

\end{tikzpicture}%
}
\caption{Four main
  stages run left to right, mirroring
  Sections~\ref{sec:background}--\ref{sec:conclusion}: physical
  foundations, the noisy Cq channel, integrated control together with
  the SJIP hardness proof, and the estimation/security synthesis.
  The cross-cutting band below collects the fibre parameters, noise
  rates, and hardness results that thread through multiple stages;
  dashed arrows show where each cross-cutting element is consumed.
  The dashed border on Conjecture~\ref{thm:decoding_hard} marks
  the paper's single conjectural (unproven) step, keeping it visibly
  distinct from the otherwise unconditional derivation chain.}
\label{fig:framework}
\end{figure*}
...
asymptotic normality (LAN) has been established~\cite{giovannetti2011,kahnguta2009}.
...
satisfies $\prod_{s \in S'} s = y$.  SJIP is a decision problem about
a specific finite \emph{subset-product} question within a semigroup,
and is therefore a different object from the classical
\emph{word problem for semigroups} --- the question of whether two
words over a generating set represent the same semigroup element ---
whose own time-complexity has been studied extensively as an
algebraic analogue of nondeterministic computation via isoperimetric
(Dehn-function) techniques~\cite{birget1998}; we draw on that
literature only for context on how algebraic problems over semigroups
can encode NP-hardness, not as a source for SJIP itself, which we
believe to be new. The connection between SJIP
...
\begin{equation}
  C(\eta) = H_2\!\left(\frac{1+e^{-2\eta|\alpha|^2}}{2}\right).
  \label{eq:C_of_eta}
\end{equation}
Differentiating directly, with $q(\eta) = (1+e^{-2\eta|\alpha|^2})/2$
and using $H_2'(q) = \log_2\bigl((1-q)/q\bigr)$ together with
$(1-q)/q = \tanh(\eta|\alpha|^2)$, gives the strictly positive rate
\begin{equation}
  \frac{\partial C}{\partial\eta} =
  \frac{|\alpha|^2\, e^{-2\eta|\alpha|^2}}{\ln 2}\,
  \ln\!\bigl(\coth(\eta|\alpha|^2)\bigr) > 0
  \quad \forall\, \eta \in (0,1),
  \label{eq:dCdeta}
\end{equation}
since $\coth(\eta|\alpha|^2) > 1$ for $\eta|\alpha|^2>0$.
...
$\eta = e^{-1} \approx 0.368$ and, from~\eqref{eq:C_of_eta},
$C \approx 0.827\,\mathrm{bits}$, whereas a 50\% noise suppression
factor ($f_1 = 0.5$) gives $\eta_c = e^{-0.5} \approx 0.607$ and
$C \approx 0.935\,\mathrm{bits}$, a $13.0\%$ capacity gain.
...
0$~\cite{viola1998,uhrig2007}, i.e.\ $\gamma_\varphi^{\mathrm{eff}} =
\gamma_\varphi f_\varphi$. The equally-spaced pulse sequence used
here is the simplest member of a broader family; non-uniformly
spaced (Uhrig-type) sequences can further improve the suppression
exponent for a given number of pulses~\cite{uhrig2007}, and are a
natural refinement for future experimental implementations of this
mechanism.
...
using the closed-form BPSK capacity of~\eqref{eq:C_BPSK_appendix}
with dephasing entering as an additional exponential suppression of
the effective mean photon number,
\begin{align}
  R_1 &= H_2\!\left(\frac{1+e^{-2\eta\bar n\,
      e^{-2\gamma_\varphi L}}}{2}\right),
    \nonumber\\
  R_2 &\le R_1, \nonumber\\
  R_3 &= H_2\!\left(\frac{1+e^{-2\eta_c\bar n\,
...
Writing $x = \eta\bar n\,e^{-2\gamma_\varphi L}$ and
$x_c = \eta_c\bar n\,e^{-2\gamma_\varphi^{\mathrm{eff}}L}$, the
argument $q(x)=(1+e^{-2x})/2$ lies in $[1/2,1)$ and is strictly
decreasing in $x$, while $H_2$ is strictly decreasing on $[1/2,1]$;
hence $R(x) = H_2(q(x))$ is strictly increasing in $x$. For any
admissible control with $\int_0^L f\,d\tau < L$ and $f_\varphi(L)<1$,
both $\eta_c>\eta$ and $\gamma_\varphi^{\mathrm{eff}}<\gamma_\varphi$
hold, giving $x_c > x$ and therefore $R_3 > R_1 \ge R_2$.
\end{theorem}
...
only if $NP \subseteq BQP$~\cite{aaronson2005}. This is consistent
with, and motivated by, the oracle-relative separation results of
Bennett, Bernstein, Brassard, and Vazirani showing that a quantum
computer cannot solve an unstructured NP search problem in
sub-exponential time relative to a random oracle~\cite{bennett1997};
that result does not by itself rule out $NP\subseteq BQP$
unconditionally, but it is the standard evidentiary basis for
treating the condition as unlikely to hold.
\end{theorem}

\subsection{Quantum Fisher Information Matrix and the QCRB}

Let the complete parameter vector be $\Theta = \theta \cup \gamma$
with $\theta = (L,\alphaf,\beta_2,a,n_{\mathrm{core}},
...
Definition~\ref{def:qfim} via~\eqref{eq:SLD} and using the diagonal
...
in the sense made precise for finite-dimensional quantum statistical
models by Kahn and Gu\c{t}\u{a}~\cite{kahnguta2009}, which
establishes the requisite Gaussian-shift-model equivalence used
here.
\end{theorem}
...
Before stating the security results, it is worth situating the
dual-layer guarantee developed below relative to two established
security paradigms, since non-injectivity of a noisy channel does
not by itself imply a cryptographic guarantee in the sense those
paradigms use the term. Quantum key distribution (QKD) protocols
such as BB84 derive their security from a proof that any measurement
an eavesdropper performs on the quantum carrier necessarily disturbs
it, so that the disturbance is detectable by the legitimate parties
during a public reconciliation step; security there is
information-theoretic and holds against an eavesdropper with
unbounded computational power, but it requires an interactive
protocol with basis reconciliation and privacy amplification, which
the present framework does not include. Physical-layer security
schemes, by contrast, typically bound an eavesdropper's channel
capacity below the legitimate receiver's (a wiretap-channel
argument) and do not generally invoke computational hardness at all;
this line of work originates with Wyner's wiretap channel, in which
secrecy capacity is characterised purely in terms of the relative
noisiness of the legitimate and eavesdropper channels with no
assumption on Eve's computational power~\cite{wyner1975}, and was
subsequently generalised to broadcast channels with confidential
messages by Csisz\'{a}r and K\"{o}rner~\cite{csiszarkorner1978}.
The guarantee of Corollary~\ref{cor:dual_security} below is
architecturally closer to the physical-layer-security family than to
QKD --- it is a passive, non-interactive bound on the information
and computational resources available to an eavesdropper who
intercepts the same channel output as the legitimate receiver,
rather than a protocol with its own reconciliation machinery --- but
it differs from standard wiretap-channel results in combining that
information-theoretic term with a \emph{second}, computational term
whose validity is conditional on Conjecture~\ref{thm:decoding_hard}
below. We do not claim the combined bound is a substitute for a
QKD-style interactive protocol or for a full wiretap-channel capacity
analysis; rather, it quantifies the specific advantage available to
a passive eavesdropper of the integrated-control channel developed
in Section~\ref{sec:methodology}, and its unconditional
(information-theoretic) component alone already recovers the
qualitative flavour of a wiretap-channel guarantee.
...
\begin{theorem}[SJIP-Based Computational Security, Conditional]
\label{thm:sjip_security}
Assume Conjecture~\ref{thm:decoding_hard} holds. Then, if $NP
\not\subseteq BQP$, for any encoding based on the quadratic-map
semigroup $(\mathcal{F}, \circ)$, any polynomial-time eavesdropper
satisfies
\begin{equation}
...
than any inverse polynomial in the block length $N$. Unlike
Proposition~\ref{thm:cap_ambiguity} and
Theorem~\ref{thm:noise_security} below, which are unconditional,
this result is stated as a theorem \emph{conditional on}
Conjecture~\ref{thm:decoding_hard}: it is a proof that the stated
conclusion follows from the conjecture's premise, not a proof of the
premise itself.
\end{theorem}

\begin{proof}
Assuming Conjecture~\ref{thm:decoding_hard}, an optimal decoder must
solve SJIP in the worst case; this is precisely the structural
correspondence the conjecture posits (Section~\ref{sec:sjip}), and is
taken here as a hypothesis rather than an established fact. Under
this hypothesis, any polynomial-time eavesdropper that achieves
advantage $\mathrm{Adv}(E) \ge 1/\mathrm{poly}(N)$ can be used as a
SJIP oracle, which in turn solves \textsc{Subset-Sum} in polynomial
time by the reduction of Theorem~\ref{thm:sjip_nphard} --- this
second step \emph{is} unconditional. Combining the two, a
non-negligible eavesdropper advantage would contradict $NP
\not\subseteq BQP$, so no such eavesdropper can exist, giving
\eqref{eq:sjip_security}, conditional on Conjecture~\ref{thm:decoding_hard}.
\end{proof}
...
\begin{proof}
Combining Proposition~\ref{thm:cap_ambiguity} with the explicit scaling
...
\end{align}
where the last inequality uses $\log_2 x \le x$ for
$x \in (0,1]$, applied with $x = e^{-\gamma_{\mathrm{loss}}L}
e^{-2\gamma_\varphi L}$.  Dividing by the noiseless advantage
...
\begin{split}
  ...
  \underbrace{\frac{1}{|\Amb(\sigma)|}}_{\text{information-theoretic}}
...
(Proposition~\ref{thm:non_inject}) and decays exponentially with fibre
length $L$; this term is \emph{unconditional}. The computational term
is bounded by Theorem~\ref{thm:sjip_security} and decays faster than
any inverse polynomial in $N$, but --- as that theorem's statement
makes explicit --- this bound holds \emph{conditional on}
Conjecture~\ref{thm:decoding_hard}; should the conjecture later be
refuted, only the computational term of~\eqref{eq:dual_security} is
affected, and the information-theoretic term continues to hold on
its own. Crucially, the two terms arise from independent
...
\begin{enumerate}[leftmargin=*, label=(\arabic*), itemsep=2pt]
  \item \textbf{Capacity scaling:}
    $C(L,a,T) = C_0\,e^{-\alphaf L}\,
    \bigl[1+(L/L_D)^2\bigr]^{-1/2}(1-e^{-\kappa/a^2})
    (1-\gamma_T(T-T_0))$, combining~\eqref{eq:Ca}--\eqref{eq:CT} (the
    dispersive factor of~\eqref{eq:CL} is retained here for
    consistency with that equation).
  \item \textbf{Noise-rate identities:}
    $\gamma_{\mathrm{loss}} = \alphaf v_g \ln 10 / 10$ and
    $\gamma_\varphi = (\omega D_p \Delta L)^2 v_g / 2$,
    from~\eqref{eq:noise_rates}.
  \item \textbf{Control-induced capacity gain (leading-order
    estimate):}
    $\Delta C/C \approx 1 - \exp\!\bigl(-\gamma_{\mathrm{loss}}
    \int_0^L(1-f(\tau))\,d\tau\bigr)$, valid in the regime where $C$
    is approximately linear in the transmission efficiency $\eta$;
    the exact gain follows from~\eqref{eq:C_of_eta} evaluated at
    $\eta$ and $\eta_c$ and is generally smaller than this estimate
    because $C(\eta)$ is concave and saturating (cf.\ the $13\%$
    exact gain against the $\approx 39\%$ efficiency gain in the
    worked example of Section~\ref{subsec:capacity_enhancement}).
  \item \textbf{SJIP hardness signature (conditional on
    Conjecture~\ref{thm:decoding_hard}):} Optimal ML decoding time
    scales as $\mathcal{O}(2^{c_0 N})$, for a constant $c_0>0$
    depending on the alphabet size $M$ (deliberately distinguished
    here from the fibre field-attenuation coefficient $\alphaf$),
    versus $\mathcal{O}(N^2)$ for polynomial-time approximations.
\end{enumerate}
...
\ref{thm:sjip_security}
  & Computational security$^\dagger$
  & $\mathrm{Adv}(E) \le \mathrm{negl}(N)$ \\[3pt]
\ref{cor:dual_security}
  & Dual-layer security$^\dagger$
  & $\Pr[\text{Eve}] \le e^{-\gamma L}
    + \mathrm{negl}(N)$ \\
\bottomrule
\multicolumn{3}{@{}p{0.47\textwidth}@{}}{\footnotesize $^\dagger$The
  computational component is conditional on
  Conjecture~\ref{thm:decoding_hard} (Section~\ref{sec:sjip}); it is
  not an unconditional theorem. The information-theoretic component
  of the dual-layer bound is unconditional on its own.}\\
\end{tabular}
\end{table}
...
$\gamma_\varphi = 0.005$\,ns$^{-1}$.  Following the
$z=v_g t$ substitution of Section~\ref{subsec:physical_foundations},
we work in group-velocity-normalised units in which the numerical
value of the propagation length, $L = 10$ (interpreted as the
elapsed propagation time $t=L/v_g=10$\,ns), is used directly with
the per-time rates $\gamma_{\mathrm{loss}},\gamma_\varphi$; i.e.\ the
product $\gamma_{\mathrm{loss}}L$ below denotes $\gamma_{\mathrm{loss}}t$.
The resulting transmission efficiency
is $\eta = e^{-\gamma_{\mathrm{loss}}L} \approx 0.819$.

These noise rates are chosen to be representative of a typical
telecom-fibre quantum link operating near 1550\,nm rather than
fitted to any specific experimental system: standard single-mode
fibre (e.g.\ SMF-28) exhibits attenuation on the order of
$0.2\,\mathrm{dB/km}$, and modern low-PMD fibre typically has a
polarisation-mode-dispersion coefficient in the
$0.01$--$1\,\mathrm{ps}/\sqrt{\mathrm{km}}$ range~\cite{agrawal2007};
the values $\gamma_{\mathrm{loss}} = 0.02\,\mathrm{ns}^{-1}$ and
$\gamma_\varphi = 0.005\,\mathrm{ns}^{-1}$ together with $L=10$\,km
were chosen to sit within this realistic order of magnitude while
placing the channel in a moderate-loss regime ($\eta\approx 0.82$)
in which both the amplitude-damping and phase-damping contributions
to the QFIM~\eqref{eq:qfim_fibre} are simultaneously non-negligible,
so that the simulation exercises both diagonal entries of $F$ rather
than only one. We emphasise that this simulation is an
\emph{algorithmic} validation of the adaptive Bayesian estimator of
Algorithm~\ref{alg:estimation} against the QCRB it is designed to
saturate (Theorem~\ref{thm:qcrb_achieve}); it is not a comparison
against experimental quantum-optical communication hardware or
against competing estimation algorithms from the literature, and no
such comparison is claimed here. Both gaps are listed explicitly as
...
At the true parameters, the QFIM~\eqref{eq:qfim_fibre} evaluates
per copy to $F_{11}\approx 0.2467$ and $F_{22}\approx 14.816$, so
that the total Fisher information accumulated over $M=50$ rounds is
\begin{equation}
  M\,F(\bar n_{\mathrm{true}},\varphi_{\mathrm{true}}) =
  \begin{pmatrix}
    12.34 & 0 \\ 0 & 740.8
  \end{pmatrix},
\end{equation}
...
speed between $\bar n$ and $\varphi$---the phase estimate reaches a
given relative precision substantially faster, consistent with
Table~\ref{tab:convergence} (e.g.\ $\mathrm{Var}(\varphi)$ is roughly
$20$--$50\times$ smaller than $\mathrm{Var}(\bar n)$ throughout the
run)---is in quantitative agreement with the ratio
$F_{22}/F_{11} \approx 60$ of the QFIM diagonal entries at the true
parameter point.
...
capacity and the quantum noise rates.  

Second, the integrated
control methodology proves that time-concurrent quantum control can
strictly increase the Cq channel capacity, illustrated by a
representative numerical example (Section~\ref{subsec:capacity_enhancement})
in which a 50\% noise-suppression factor yields a $13\%$ capacity
gain, thereby overcoming the ceiling
imposed by the Quantum Data Processing Inequality on purely
post-channel correction schemes.  

Third, the NP-hardness analysis
provides a rigorous, unconditional polynomial-time reduction from
\textsc{Subset-Sum} to the Semigroup Julia Inversion Problem via a
quadratic-map semigroup, establishing as a proven complexity-theoretic
fact that SJIP itself is NP-hard; we further argue, explicitly as
Conjecture~\ref{thm:decoding_hard} rather than a proven claim, that
optimal coherent-state decoding inherits this hardness, and we have
been careful throughout to keep this conjectural correspondence
distinct from the unconditional SJIP result. 

Fourth, the security
analysis combines channel non-injectivity (an unconditional
information-theoretic layer) with SJIP hardness (a computational
layer whose applicability to decoding is conditional on
Conjecture~\ref{thm:decoding_hard}) to derive a dual-layer security
guarantee in which the eavesdropper's total advantage is bounded by
the sum of an unconditional exponentially decaying term and a
conditional negligible term.
...
\begin{enumerate}[leftmargin=*, label=(\arabic*), itemsep=2pt]
  \item \textbf{Resolving the decoding-hardness conjecture.}  As
    flagged in Section~\ref{sec:sjip}, we regard this as the single
    most important open question raised by this paper: either
    exhibit a genuine polynomial-time reduction from SJIP to optimal
    coherent-state decoding by constructing a semigroup operation on
    the overlap values $\omega(x,y|\theta)$ (or on the operators
    $\Pi_y\rho(x|\theta)$) under which they compose as the generators
    of $G=\langle\mathcal F\rangle$ do, thereby upgrading
    Conjecture~\ref{thm:decoding_hard} to a theorem; or exhibit a
    polynomial-time decoding algorithm, which would refute it.
    Either outcome would resolve the conditional status of
    Theorem~\ref{thm:sjip_security} and
    Corollary~\ref{cor:dual_security}.
  ...
  \item \textbf{Experimental validation.}  Laboratory implementation
    ...
    confirmation of prediction~(3) in Section~\ref{sec:security}; it
    would also provide a direct experimental comparison against the
    purely algorithmic validation of Algorithm~\ref{alg:estimation}
    given in Section~\ref{sec:simulation}, which was not benchmarked
    against physical hardware or competing estimation schemes.
  ...
  \item \textbf{Quantum key distribution.}  Applying the
    ...
    information-theoretic proofs, including the classical wiretap
    and confidential-message-broadcast guarantees
    of~\cite{wyner1975,csiszarkorner1978}.
...
For BPSK with antipodal coherent-state encoding
$\rho(0)=|\alpha\rangle\langle\alpha|$,
$\rho(1)=|-\alpha\rangle\langle-\alpha|$, both signal states are
\emph{pure}, so $S(\rho(x))=0$ for $x\in\{0,1\}$ and the Holevo
quantity collapses to $\chi(p) = S(\bar\rho(p))$ with no subtracted
entropy term. Writing the overlap $s = \langle\alpha|{-\alpha}\rangle
= e^{-2|\alpha|^2}$, the mixed state $\bar\rho(p) =
p\,\rho(0)+(1-p)\,\rho(1)$ has eigenvalues $\tfrac12\bigl(1\pm
\sqrt{1-4p(1-p)(1-s^2)}\bigr)$ on the two-dimensional span of
$\{|\alpha\rangle,|-\alpha\rangle\}$; the spread of these eigenvalues
(and hence $S(\bar\rho(p))$, by concavity of $H_2$) is maximised at
the symmetric prior $p=1/2$, giving the closed form
\begin{equation}
  C = H_2\!\left(\frac{1+e^{-2|\alpha|^2}}{2}\right),
  \label{eq:C_BPSK_appendix}
\end{equation}
where $H_2(x) = -x\log_2 x - (1-x)\log_2(1-x)$ is the binary entropy
function, consistent with the general treatment of channel capacity
and entropy quantities in~\cite{cover2006}. (The similar-looking
quantity $H_2\bigl((1+\sqrt{1-e^{-4|\alpha|^2}})/2\bigr)$ is the
Helstrom \emph{minimum-error discrimination} success probability for
this constellation, not an eigenvalue of $\bar\rho$; it is a
different, generally larger, quantity and should not be substituted
for~\eqref{eq:C_BPSK_appendix} when computing the Holevo capacity.)
...
\bibitem{wyner1975}
A.~D.~Wyner, ``The wire-tap channel,'' \emph{Bell Syst.\ Tech.\ J.},
vol.~54, no.~8, pp.~1355--1387, 1975.

\bibitem{csiszarkorner1978}
I.~Csisz\'{a}r and J.~K\"{o}rner, ``Broadcast channels with
confidential messages,'' \emph{IEEE Trans.\ Inf.\ Theory}, vol.~24,
no.~3, pp.~339--348, 1978.

\bibitem{bennett1997}
C.~H.~Bennett, E.~Bernstein, G.~Brassard, and U.~Vazirani,
``Strengths and weaknesses of quantum computing,''
\emph{SIAM J.\ Comput.}, vol.~26, no.~5, pp.~1510--1523, 1997.

\bibitem{uhrig2007}
G.~S.~Uhrig, ``Keeping a quantum bit alive by optimized
$\pi$-pulse sequences,'' \emph{Phys.\ Rev.\ Lett.}, vol.~98,
p.~100504, 2007.

\bibitem{kahnguta2009}
J.~Kahn and M.~Gu\c{t}\u{a}, ``Local asymptotic normality for
finite dimensional quantum systems,'' \emph{Commun.\ Math.\ Phys.},
vol.~289, pp.~597--652, 2009.

\bibitem{birget1998}
J.-C.~Birget, ``Time-complexity of the word problem for semigroups
and the Higman embedding theorem,'' \emph{Int.\ J.\ Algebra
Comput.}, vol.~8, no.~2, pp.~235--294, 1998.
